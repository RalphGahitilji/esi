			...
			<div class="row">
				<div class="container bloc">
						...
						<form method="POST" action="{{ route('login') }}">
							...
							<!-- Email Address -->
							<div class="mt-4">
								<input id="email" class="form-control block mt-1 w-full" type="email" placeholder="EMAIL" name="email" :value="old('email')" required autofocus autocomplete="username" />
							...
							<div class="mt-4 relat">
								...
								<input id="password" class="form-control block mt-1 w-full" type="password" placeholder="MOT DE PASSE" name="password" required autocomplete="current-password" />
